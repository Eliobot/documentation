...
<br/>Senzorii de linie ai lui Eliobot sunt senzori cu infraroșu care detectează linii.

## Utilizați cu Elioblocs

Pentru a folosi senzorii de linie Eliobot pe Elioblocs, folosim blocuri din categoria <img src={require("@site/static/img/eliobot/senors-line/category-follow-line.jpg").default} style={{ width: "14%", verticalAlign: "middle" }} alt="categorie linie" />.
...
|     | Senzor 1 | Senzorul 2 | Senzorul 3 | Senzor 4 | Senzorul 5 |
|-----|-----------|-----------|-----------|-----------|-----------|
...
Aici, dacă detectăm o linie sub senzorul 3 (senzorul din mijloc), mergem înainte.
Pragul de detecție este 30000, este o valoare aproximativă, trebuie calibrat pentru funcționare optimă.