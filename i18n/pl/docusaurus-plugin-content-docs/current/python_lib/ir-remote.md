...
sidebar_position: 6
title: "IRRemote"
description: "Klasa IRRemote — odbiór sygnałów podczerwieni"
---

# IRRemote

Klasa `IRRemote` zarządza odbiorem sygnałów podczerwieni emitowanych przez pilota Eliobota.
...
Klasa udostępnia słownik klas `signals` ze wszystkimi przyciskami na pilocie:
...
Dekoduje odebrany sygnał podczerwieni i zwraca kod w postaci krotki lub `None`, jeśli nie ma prawidłowego sygnału.
...
## Kompletny przykład — pilot do sterowania silnikami
