...
SRC_DOCS = Path("docs")
DST_DOCS = Path("i18n/ro/docusaurus-plugin-content-docs/current")
CACHE_FILE = Path(".translation_cache_fr_ro.json")
...
def main():
    ...
    process_message_json(Path("i18n/ro/docusaurus-theme-classic/navbar.json"), cache)
    process_message_json(Path("i18n/ro/docusaurus-theme-classic/footer.json"), cache)
    process_message_json(Path("i18n/ro/docusaurus-plugin-content-docs/current.json"), cache)

    code_path = Path("i18n/ro/code.json")
